...
- Claude Code → CLAUDE.md，再复制一份到 .claude/commands/minipatch.md
- Trae → .trae/rules/minipatch.md
- WorkBuddy → .workbuddy/skills/minipatch/SKILL.md
...
> `https://cdn.jsdelivr.net/gh/konlue/skills@main/minipatch/SKILL.md`
...
curl -fsSL https://raw.githubusercontent.com/konlue/skills/main/minipatch/install.sh | bash -s -- --all
```
